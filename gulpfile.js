...
exports.default = series(clean, sprites, htmlInclude, scripts, styles, libsCss, resources, fonts, php, media, images, svgSprites, watchFiles);

exports.build = series(toProd, clean, sprites, htmlInclude, scripts, styles, libsCss, resources, fonts, php, media, images, svgSprites);
